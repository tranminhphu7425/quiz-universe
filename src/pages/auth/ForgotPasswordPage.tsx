...
export default function ForgotPasswordPage() {
        ...
        <div className="relative min-h-screen overflow-hidden bg-slate-50 dark:bg-slate-950">
            ...
            <Floating distance={12} duration={7} className="pointer-events-none absolute top-16 left-8">
                <div className="rounded-xl bg-gradient-to-br from-amber-300 to-rose-300 px-3 py-1 shadow-lg -rotate-6">
                    <span className="text-xs font-black text-rose-700">RESET!</span>
                </div>
            </Floating>
    ...
    "
                    ...
                    >
                        ...
                        {error && (
                            <div className="mb-3 rounded-lg bg-rose-500/15 px-3 py-2 text-sm text-rose-100 ring-1 ring-rose-500/30">
                                {error}
                            </div>
                        )}

                        {sent ? (
                            <div className="mb-2 rounded-lg bg-emerald-500/15 px-3 py-2 text-sm text-emerald-100 ring-1 ring-emerald-500/30">
                        ...
                        >
                            {loading ? "Đang gửi..." : sent ? "Đã gửi" : "Gửi liên kết đặt lại"}
                        ...
                        <p className="text-center text-sm text-white/90 dark:text-gray-300">
                            Nhớ mật khẩu rồi?{" "}
                            <Link to="/login" className="font-semibold text-amber-300 underline-offset-2 hover:underline">
                                Đăng nhập
                            </Link>
                        </p>
                    </motion.form>
