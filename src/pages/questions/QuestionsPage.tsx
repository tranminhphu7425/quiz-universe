...
export type Question = {
  ...
  stem: string;
  explanation?: string;
  questionType: "mcq_single" | string; // extend later
  status?: string;
  createdAt?: string;
  updatedAt?: string;
  options: Option[];
...
// ====== Page ======
export default function QuestionsPage({ questions = demoQuestions }: { questions?: Question[] }) {
      ...
      <div className="relative">
        <div className="absolute right-5 top-10 w-fit h-full">
          <div className="sticky top-20 w-fit">
            ...
            {/* Drawer phải */}
            {navOpen && (
              <div className=" inset-0 z-50 h-3/4 my-auto">
