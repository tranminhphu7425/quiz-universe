...
import { QuestionBankCardGridProps } from "./QuestionBankCardGrid";

export function QuestionBankCardList({ bank, isFavorite, isSelected, onToggleFavorite, onToggleSelect, userRole, userId, onDelete }: QuestionBankCardGridProps) {
